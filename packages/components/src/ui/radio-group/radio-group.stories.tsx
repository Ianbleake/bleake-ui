		...
		return (
			<div className="flex flex-col gap-3">
				<RadioGroup value={value} onValueChange={setValue} className="flex gap-6">
					<div className="flex items-center gap-2">
						<RadioGroupItem value="plan-basic" id="p1" />
						<Label htmlFor="p1">Basic</Label>
					</div>
					<div className="flex items-center gap-2">
						<RadioGroupItem value="plan-pro" id="p2" />
						<Label htmlFor="p2">Pro</Label>
					</div>
					<div className="flex items-center gap-2">
						<RadioGroupItem value="plan-enterprise" id="p3" />
	...
	render: () => (
		<RadioGroup defaultValue="option-1">
			...
			<div className="flex items-center gap-2">
				...
				<Label htmlFor="d2" className="text-muted-foreground">Option 2 (disabled)</Label>
			</div>
			<div className="flex items-center gap-2">
				<RadioGroupItem value="option-3" id="d3" disabled />
				<Label htmlFor="d3" className="text-muted-foreground">Option 3 (disabled)</Label>
			</div>
		</RadioGroup>
	),
};
		...
		return (
			<RadioGroup value={value} onValueChange={setValue}>
				<div className="flex items-start gap-3">
					<RadioGroupItem value="monthly" id="b1" className="mt-1" />
				...
				<div className="flex items-start gap-3">
					<RadioGroupItem value="yearly" id="b2" className="mt-1" />
					<div className="flex flex-col gap-0.5">
